  ...
  const handleSubmit = (e) => {
    ...
    post(route("sensors.store"), {
      onSuccess: (msg) => {
        Swal.fire({
          title: "Success!",
          text: "Sensor Stored successfully",
          icon: "success",
      ...
      <div className="container">
        <div className="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
          <div className="card-header text-center">
            <h1 className={"m-4"}>Add Sensor</h1>
          </div>
          <div className="card-body ">
            {/* form details */}
            <form onSubmit={handleSubmit}>
              <div className="col-md-12 my-2">
                <label htmlFor="weight">Sensor Name</label>
                <Input
                  name="Name"
              ...
              <div className="col-md-6 my-4">
                <label htmlFor="">Sensor Owner</label>
                <select
                  value={data.owner}
                  name="owner"
              ...
              <div className="col-md-12 my-4">
                <label htmlFor="">Attached Device</label>
                <select
                ...
                {errors.device_id && (
                  <div className="alert alert-danger">{errors.device_id}</div>
                )}
              </div>
              {/* attached device */}
              ...
              {/* type*/}
              <div className="col-md-12 my-4">
                <label htmlFor="weight">Sensor Type </label>
                <input
                  type={"text"}
                  value={data.type}
                  className="form-control"
              ...
              {/* location */}
              <div className="col-md-12 my-4">
                <label htmlFor="weight">Sensor Location</label>
                <input
                  type={"text"}
                  value={data.location}
              ...
              {/* version */}
              <div className="col-md-12 my-4">
                <label htmlFor="weight">Sensor Version</label>
                <input
                  type={"text"}
                  value={data.version}
              ...
              {/* modal */}
              <div className="col-md-12 my-4">
                <label htmlFor="weight">Sensor Model</label>
                <input
                  type={"text"}
                  value={data.model}
              ...
              <div className="col-md-12 my-2">
                <button
                  ...
                  disabled={processing}
                >
                  {processing ? "Processing..." : "Add Sensor"}
                </button>
              </div>
              {/* button */}
            </form>
